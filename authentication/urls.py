...
from authentication.views import isFeide

from authentication.views import SignUpView, SignUpDoneView, SignUpConfirmView
...
if isFeide:
    urlpatterns = [
        url(r'^logout/$', RedirectView.as_view(url="http://auth.dataporten.no/logout"), name='logout'),
    ]
else:
    urlpatterns = [
        url(r'^login/$', auth_views.LoginView.as_view(template_name="login.html"), name='login'),
        url(r'^logout/$', auth_views.LogoutView.as_view(template_name="redirection_page.html"), name='logout'),
