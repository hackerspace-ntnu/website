...
urlpatterns = [
        ...
        path('api/<int:pk>/', ReservationViewSet.as_view({'get': 'list', 'post': 'create'}),
             name='reservation_api'),
        path('api/delete/<int:pk>/', ReservationViewSet.as_view({'post': 'destroy'}), name='reservation_delete_api'),
        path('api/update/<int:pk>/', ReservationViewSet.as_view({'post': 'update'}), name='reservation_update_api'),
]
